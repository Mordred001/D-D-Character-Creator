...
using D_D_Character_Creator.Data.Spells;
using System;
...
namespace D_D_Character_Creator.Data
{
    ...
    public class Spell : IComparable<Spell>, IXML, IOGLElement<Spell>, IOGLElement
    {
        ...
        public Spell(DnDContext context, int level, string name, string castingTime, string range, string duration, string description)
        {
            Keywords = new List<Keyword>();
            Descriptions = new List<Description>();
            Level = level;
        ...
        public void Register(DnDContext context, String file)
        {
            FileName = file;
