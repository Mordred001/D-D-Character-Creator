...
namespace D_D_Character_Creator.Data.Items
{
    public class Category: IComparable<Category>
    {
        ...
        public static Category Make(DnDContext context)
        {
        ...
        public Category(String path, IEnumerable<string> categorypath, DnDContext context)
        {
        ...
        public Category(DnDContext context)
        {
            ItemsDir = context.Config.Items_Directory;
