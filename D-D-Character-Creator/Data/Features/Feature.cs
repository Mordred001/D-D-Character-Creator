...
namespace D_D_Character_Creator.Data.Features
{
    public class Feature : IComparable<Feature>, IXML, IInfoText
    {
        ...
        public Feature AssignCategory(DnDContext context, string cat)
        {
            Category = cat;
        ...
        public virtual List<Feature> Collect(int level, IChoiceProvider choiceProvider, DnDContext context)
        {
