...
namespace D_D_Character_Creator.Data
{
    public class Background : IComparable<Background>, IXML, IOGLElement<Background>, IOGLElement
    {
        ...
        public Background(DnDContext context, String name, String description)
        {
            Name = name;
        ...
        public List<Feature> CollectFeatures(int level, IChoiceProvider provider, DnDContext context)
        {
